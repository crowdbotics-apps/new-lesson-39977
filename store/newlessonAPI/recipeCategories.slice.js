...
export const api_v1_recipecategory_list = createAsyncThunk("recipeCategories/api_v1_recipecategory_list", async payload => {
  const response = await apiService.api_v1_recipecategory_list(payload);
  return response.data;
});
export const api_v1_recipecategory_create = createAsyncThunk("recipeCategories/api_v1_recipecategory_create", async payload => {
  const response = await apiService.api_v1_recipecategory_create(payload);
  return response.data;
});
export const api_v1_recipecategory_retrieve = createAsyncThunk("recipeCategories/api_v1_recipecategory_retrieve", async payload => {
  const response = await apiService.api_v1_recipecategory_retrieve(payload);
  return response.data;
});
export const api_v1_recipecategory_update = createAsyncThunk("recipeCategories/api_v1_recipecategory_update", async payload => {
  const response = await apiService.api_v1_recipecategory_update(payload);
  return response.data;
});
export const api_v1_recipecategory_partial_update = createAsyncThunk("recipeCategories/api_v1_recipecategory_partial_update", async payload => {
  const response = await apiService.api_v1_recipecategory_partial_update(payload);
  return response.data;
});
export const api_v1_recipecategory_destroy = createAsyncThunk("recipeCategories/api_v1_recipecategory_destroy", async payload => {
